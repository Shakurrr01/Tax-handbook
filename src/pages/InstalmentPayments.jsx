  ...
  const content = {
    en: {
      ...
      content: [
        ...
        {
          type: "paragraph",
          text: "The IQP annexure has two tabs. Only the tabs that are applicable in that tax period need to be completed, validated and saved. See page 99 if the taxpayer has any problems when validating annexures."
        },
        {
          type: "heading",
        ...
        {
          type: "paragraph",
          text: "After all applicable IQP annexures (if any) have been completed, validated and saved in the folder C:/RRA in the user's local machine, the taxpayer can return to E-Tax to complete the IQP declaration, see page 103 for more detail on selecting the relevant declaration. The taxpayer must choose the relevant PIT or CIT declaration, but the details required are the same."
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          text: "If the taxpayer has had any tax withheld and paid on their behalf during the tax period, upload the IQP annexures and then compare with the declaration form, see page 107 for more detail on uploading annexures and comparing with declaration forms."
        },
        {
          type: "heading",
          text: "Example 26"
        ...
        {
          type: "paragraph",
          text: "Click to 'View Acknowledgement Receipt' to view the RRA reference number and the total tax due that are required for payment. See page 438 for more details on paying taxes. Remember that payment must also be made before the deadline to avoid penalties and fines."
        }
      ]
    },
    fr: {
