        ...
        <div className="page-container">
            ...
            <div className="page-content">
                ...
                <section className="content-section">
                    ...
                    <p>
                        Based on the type of motor vehicle registered to the number plate, the system selects the Income Tax to be paid and generates the RRA Reference Number required for payment. For paying taxes, see page 436.
                    </p>
                </section>
            </div>
        </div>
