  ...
  const content = {
    en: {
      ...
      content: [
        ...
        {
          type: "paragraph",
          text: "In the event that an employer has special authorisation from the Government of Rwanda that they are not required to declare and pay taxes on income, see page 120, their employees are required to register with RRA, and declare and pay PAYE on their own behalf."
        },
        {
          type: "heading",
